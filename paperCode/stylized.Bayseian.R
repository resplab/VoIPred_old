...
n_sim <- 100000 #More simulation runs because of autocorrelation in MCMC
...
readr::write_rds(c(ENB_all,ENB_model,ENB_max,EVPI,EVPI_r),here("paperCode","supp_results","Bayesian.rds"))
